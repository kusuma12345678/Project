        ...
        <form action="" method="post">
            <fieldset>
                ...
                <?php
                    ...
                    $semester_result=mysqli_query($conn,"SELECT `name` FROM `semester`");
...
<?php
    if(isset($_POST['semester_name'],$_POST['rno'])) {
        $semester_name=$_POST['semester_name'];
        $rno=$_POST['rno'];
        echo $semester_name;
        echo $rno;
        $delete_sql=mysqli_query($conn,"DELETE from `result` where `rno`='$rno' and `semester`='$semester_name'");
        if(!$delete_sql){
    ...
    if(isset($_POST['rn'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['class'])) {
        ...
        $sql="UPDATE `result` SET `p1`='$p1',`p2`='$p2',`p3`='$p3',`p4`='$p4',`p5`='$p5',`marks`='$marks',`percentage`='$percentage' WHERE `rno`='$rno' and `semester`='$semester_name'";
